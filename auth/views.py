...
def content(request, category, option_name):
    ...
    page_content = {
        ...
        "EQ" : {
                'Wellington' : '''Wellington Management Company is a private, independent investment management firm with client assets under management totaling over US$1 trillion based in Boston, Massachusetts, United States.
                ...
                'Henderson' : '''Henderson Group plc was a global investment management company with its principal place of business in the City of London. It merged with Janus Capital Group in May 2017 to create Janus Henderson.
